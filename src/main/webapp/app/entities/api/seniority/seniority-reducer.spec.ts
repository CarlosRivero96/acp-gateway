...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './seniority.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SENIORITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_SENIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SENIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SENIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SENIORITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SENIORITY actions', async () => {
      const expectedActions = [
        {
