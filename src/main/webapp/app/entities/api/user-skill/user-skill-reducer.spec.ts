...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERSKILL_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERSKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERSKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERSKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERSKILL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERSKILL actions', async () => {
      const expectedActions = [
        {
