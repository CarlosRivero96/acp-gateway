...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './user-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERDATA actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERDATA actions', async () => {
      const expectedActions = [
        {
