...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERMISSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERMISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERMISSION actions', async () => {
      const expectedActions = [
        {
