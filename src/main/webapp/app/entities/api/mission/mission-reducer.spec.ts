...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './mission.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MISSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_MISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MISSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MISSION actions', async () => {
      const expectedActions = [
        {
