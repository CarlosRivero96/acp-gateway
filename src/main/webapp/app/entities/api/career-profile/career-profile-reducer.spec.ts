...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CAREERPROFILE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CAREERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CAREERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CAREERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CAREERPROFILE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CAREERPROFILE actions', async () => {
      const expectedActions = [
        {
