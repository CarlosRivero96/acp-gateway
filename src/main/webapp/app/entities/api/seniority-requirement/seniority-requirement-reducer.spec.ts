...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './seniority-requirement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SENIORITYREQUIREMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SENIORITYREQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SENIORITYREQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SENIORITYREQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SENIORITYREQUIREMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SENIORITYREQUIREMENT actions', async () => {
      const expectedActions = [
        {
